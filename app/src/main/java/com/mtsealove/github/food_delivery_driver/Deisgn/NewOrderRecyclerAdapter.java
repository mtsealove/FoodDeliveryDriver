...
import com.mtsealove.github.food_delivery_driver.NewOrderActivity;
...
public class NewOrderRecyclerAdapter extends RecyclerView.Adapter<NewOrderRecyclerAdapter.ItemViewHolder> {
    Context context;


    public NewOrderRecyclerAdapter(Context context) {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private void SetMine(final String orderTime) {
            ...
            builder.setTitle("확인")
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Call<Result> call = restAPI.getRetrofitService().UpdateStatus(3, orderTime, LoginActivity.login.getManagerID(), LoginActivity.login.getID());
